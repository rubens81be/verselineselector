...
{    
    ...
    public bool IsComplete => CurrentParagraph is not null && AreAllVerselineConditionsSatisfied && IsTopMostMinimumCheckConditionSatisfied;
    ...
    private void UpdateParent(ObservableVerseline verseline, PropagationType propagationType)
    {
        ...
        bool needsPropagation = (parent.Verseline.MinimumChecks == 0) 
